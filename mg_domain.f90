...
!
!    if(my_hgen > 1) then
!       write(700+mype_hgen,'(a,2i5)')'mype_hgen,itargdn_sw=',mype_hgen,itargdn_sw
!       write(700+mype_hgen,'(a,2i5)')'mype_hgen,itargdn_se=',mype_hgen,itargdn_se
!       write(700+mype_hgen,'(a,2i5)')'mype_hgen,itargdn_nw=',mype_hgen,itargdn_nw
!       write(700+mype_hgen,'(a,2i5)')'mype_hgen,itargdn_ne=',mype_hgen,itargdn_ne
!       write(700+mype_hgen,'(a,2i5)')' '
!    endif
!    if(Flsendup_sw(2)) then
